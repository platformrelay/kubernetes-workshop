...
> **Deck location note:** the deck currently sits in the initial Slidev starter folder and
> is still the stock template. Restructuring it to root-level root decks + `pages/SNN-topic/`
> section folders (per the outline) is milestone M1/M2 — do this before authoring curriculum.
> Do not treat the starter's demo slides as workshop content.
